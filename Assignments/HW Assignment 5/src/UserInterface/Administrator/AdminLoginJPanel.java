...
public class AdminLoginJPanel extends javax.swing.JPanel {
    ...
    public AdminLoginJPanel(JPanel CardSequenceJPanel, UserAccountDirectory userAccountList, PersonDirectory personlist) {
        initComponents();
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        UserAccount ua=userAccountList.isValidUser(username, password);
        UserAccount a  = ua;
        if(ua==null)
        {
        ...
        {
        AdminWorkAreaJPanel panel = new AdminWorkAreaJPanel(CardSequenceJPanel,userAccountList,personlist,a);
